...
<body>
    <div class="wrap">
        <div class="header">
            <div class="header_top">
                <div class="logo">
                    <a href="index.php"><img src="images/logo.jpg" alt="" /></a><div class="col_1_of_4 span_1_of_4"><h4>NOS VAMOS</h4></div>
                </div>
                <div class="header_top_right">
                    <div class="search_box">
                        <form>
                            <input type="text" value="Buscar viaje" onfocus="this.value = '';" onblur="if (this.value == '') {
                                        this.value = 'Buscar viaje';
                    ...
                    <div id="navegador">
                        <div class="menu">
                            <ul id="dc_mega-menu-orange" class="dc_mm-orange">
                                ...
                                <li><a href="Categorias.php">Viajes</a></li>
            ...
            <div class="main">
                <div class="content">
                    ...
                    <div class="register_account" id="register_accoun">
            ...
            <div class="section group">
                ...
                <div class="col_1_of_4 span_1_of_4">
                    ...
                    <div class="social-icons">
                        ...
                        <ul>
                            <li class="facebook"><a href="https://www.facebook.com/teban.bolivaravila" target="_blank"></a></li>
    ...
    if (isset($_SESSION['loggedin'])) {
        ?> 
    <script lenguage="JavaScript" type="text/javascript" src="js/Ocultar_1.js">formAdmi();</script>
        <?php
